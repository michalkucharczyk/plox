...
Output files:
  ...
  -x, --do-not-display
          ...
          If provided, the image viewer (default system or configured by PLOX_IMAGE_VIEWER environment variable) will not be opened to display the generated graph image.
