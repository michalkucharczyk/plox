...
set output './tests/examples/panels-two-files.png'
...
plot \
   csv_data_file_0000 using (combine_datetime('date','time')):'count' with lines axes x1y1 title 'count of SOME_EVENT (default-other)', \
   csv_data_file_0001 using (combine_datetime('date','time')):'value' with points ps 2 axes x1y2 title 'presence of SOME_EVENT (default-other)'
unset y2tics
unset my2tics
...
plot \
   csv_data_file_0000 using (combine_datetime('date','time')):'count' with lines axes x1y1 title 'count of SOME_EVENT (default)', \
   csv_data_file_0001 using (combine_datetime('date','time')):'value' with points ps 2 axes x1y2 title 'presence of SOME_EVENT (default)'
unset y2tics
unset my2tics
...
plot \
   ...
   csv_data_file_0002 using (combine_datetime('date','time')):'value' with lines axes x1y1 title 'value of x03 (default-other)'
unset y2tics
unset my2tics
...
plot \
   ...
   csv_data_file_0002 using (combine_datetime('date','time')):'value' with lines axes x1y1 title 'value of x03 (default)'
unset y2tics
unset my2tics
